...
@section('content')
    ...
    <!-- Hero -->
    <div class="navbar-transparent px-md-0 img pb-md-5 navbar-wrap bg-transparent" style="background-image: url({!! asset('/storage/svg/user.svg') !!}); height: 400px;" data-stellar-background-ratio="0.5">
        ...
        @if(Auth::user()->Admin())
            <section class="ftco-section">
                <div class="container">
                    <div class="row">
                        <div class="mt-3">
                            @include('userLevels.modal.update')
                        </div>
                    </div>
                </div>
            </section>

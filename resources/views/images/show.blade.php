...
@section('content')
    ...
    <!-- Hero -->
    <div class="navbar-transparent px-md-0 img pb-md-5 navbar-wrap bg-transparent" style="background-image: url({!! asset('/storage/svg/photo.svg') !!}); height: 400px;" data-stellar-background-ratio="0.5">
